...
**Status: Phase 1 of 13 complete** (Foundation + database + configuration).
Everything below describes what is actually implemented today; features from
later phases (ingestion, chunking, retrieval, reranking, the agentic loop,
...
and rationale, and the implementation plan below for what's next.
...
- No CI pipeline yet
- Everything past Phase 1 (retrieval, generation, citations, evaluation) does
  not exist yet — there is no answer-generation or retrieval endpoint to call
  today beyond `/health`
